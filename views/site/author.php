...
<div id="custom">
	...
	<hr />
		...
		<p>Для тех, кому интересно, как я вообще начинал (а начинал я абсолютно с нуля, как и многие из Вас, думаю), посмотрите это видео, которое так и называется: <a rel="external" href="<?=Yii::$app->urlManager->createUrl(["site/post", 'id' => 8])?>">Моя история</a>.</p>
