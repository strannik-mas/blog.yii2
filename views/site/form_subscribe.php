...
<h3>Заполните форму</h3>
	<form name="subscribe_<?=$course->id?>" action="https://srs.myrusakov.ru/subscribe?utm_source=Blog.MyRusakov.ru&utm_campaign=freephp2" method="post" onsubmit="return SR_submit(this)">
		<p>
