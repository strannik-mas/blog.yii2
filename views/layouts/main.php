...
<!-- Yandex.Metrika counter -->
	<script type="text/javascript">
		(function (d, w, c) {
			(w[c] = w[c] || []).push(function() {
				try {
					w.yaCounter34511635 = new Ya.Metrika({
						id:34511635,
						clickmap:true,
						trackLinks:true,
	...
	<noscript><div><img src="https://mc.yandex.ru/watch/34511635" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
	<!-- /Yandex.Metrika counter -->
		<div id="bg">
		<div id="container">
			<div id="header">
					...
					<table>
						...
						<tr>
							<td colspan="2" class="center">
								<img src="/web/images/courses/freeim.png" alt="Пример создания Интернет-магазина на OpenCart 2.0" />
							</td>
						</tr>
					</table>
					<p class="center">
